...
// import { mongoClient } from './mongoConnect';
  ...
  survey: [
    ...
    },
    {
      ...
      answer: [
        ...
        {
          text: '또..? 동료가 혼날 것을 걱정하여 위로해주러 달려간다.',
          result: 'F',
        },
      ],
    },
...
const getCounts = async (req, res) => {
  try {
    ...
    console.error(err);
    res.status(500).json('방문자 수 가져오기 실패, 알 수 없는 문제 발생');
  }
};
...
// export { setData, getData, getCounts, incCounts };
